...
3-) Verileriniz, erişimi şifreleme ile kısıtlanmış bir veritabanında tutulur. Sorularınız için bot geliştiricileri ile [iletişime](https://discord.gg/47YTYCb8JE) geçebilirsiniz.
...
5-) Hiçbir çekinme duymadan [destek](https://discord.gg/47YTYCb8JE) sunucusuna gelip soru sorabilirsiniz.
